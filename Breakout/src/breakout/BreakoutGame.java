...
public class BreakoutGame {
    ...
    /**
     * Lets the user move the paddle with a mouse. Also makes the ball move, checks for different 
    ...
    /**
     * Checks to see if the user won the game. The user wins if they hit all the bricks on the canvas.
     * @return true if the bricksLeft variable becomes 0. The bricksLeft variable needs to be manually
    ...
    /**
     * Checks to see if the user lost the game. The user loses the game if the ball touches the bottom
     * of the canvas 3 times.
     * @return true if the life variable becomes 0. The bricksLeft variable needs to be manually
